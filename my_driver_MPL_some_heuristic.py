...
class MyDriver(Driver):
    ...
    def drive(self,carstate: State) -> Command:
        ...
        if accelerate>0 or (carstate.speed_x+carstate.speed_y+carstate.speed_z) < 15:
            brake=0;
            
        if (carstate.speed_x+carstate.speed_y+carstate.speed_z) < 15 and accelerate<.5:
            accelerate = .5
        
        print(accelerate, brake, output[0,2])
        command.accelerator = accelerate
        command.brake = brake
        command.steering = output[0,2]/50
